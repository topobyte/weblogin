...
public class UserLinkDefs
{

	public static PathDef0 CHANGE_PASSWORD = new PathDef0(
			new PathSpec("user", "change-password"));
	public static PathDef0 CHANGE_PASSWORD_SUBMIT = new PathDef0(
			new PathSpec("user", "change-password-submit"));
	public static PathDef0 PREFERENCES = new PathDef0(
			new PathSpec("user", "preferences"));
