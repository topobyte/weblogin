...
import de.topobyte.weblogin.resolving.LoginPathResolver;
import de.topobyte.weblogin.resolving.UserPathResolver;
import de.topobyte.weblogin.testing.pages.base.WebloginContentGeneratorFactory;
import de.topobyte.weblogin.testing.resolving.MainPathResolver;
...
public class IndexServlet extends HttpServlet
{
	...
	static {
		...
		resolvers.add(
				new LoginPathResolver(new WebloginContentGeneratorFactory()));
		resolvers.add(
